...
function ExpenseForm({ submitButtonLabel, onCancel, onSubmit, defaultValues }) {
  ...
  function inputChangedHandler(inputIdentifier, enteredValued) {
    setInputs((curInputs) => {
      return {
        ...curInputs,
        [inputIdentifier]: { value: enteredValued, isValid: true }
      }
    })
  }
  ...
  function submitHandler() {
    const expenseData = {
      amount: +inputs.amount.value, // the plus convert the string to number
